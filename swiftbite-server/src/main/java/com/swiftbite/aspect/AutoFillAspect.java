package com.swiftbite.aspect;

import com.swiftbite.annotation.AutoFill;
import com.swiftbite.constant.AutoFillConstant;
...
public class AutoFillAspect {
     ...
     * 切入点
     */
    @Pointcut("execution(* com.swiftbite.mapper.*.*(..)) && @annotation(com.swiftbite.annotation.AutoFill)") //满足在mapper包下的所有类添加了AutoFill注解的方法
